...
import { getKanbanAssigneeData } from '../../../../../api/kanban/assignees';
...
export async function GET(request: NextRequest) {
  ...
  const { data: { user }, error: authError } = await supabase.auth.getUser();
    ...
    await getKanbanAssigneeData(requestWithUser as RequestWithUser, resAdapter as ResponseAdapter);
    ...
    console.error('Erro na rota /api/kanban/assignees:', error);
    return NextResponse.json(
